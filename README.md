...
## Features
1. Interactive 3D models of three historical Indian astronomical instruments
2. Location-based dimension calculations (latitude/longitude input)
3. Time-based shadow simulation for Samrat Yantra
4. Celestial tracking visualization for Bhitti and Nadi Valaya Yantras
5. Interactive time controls for dynamic simulations
6. Educational content about historical significance
7. Astronomical calendar for celestial events (solstices, equinoxes, eclipses)
8. Responsive heritage-astronomy themed UI
